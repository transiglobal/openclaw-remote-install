...
if [[ "$NODE_VER" == "v18"* ]] || [[ "$NODE_VER" == *"not found"* ]]; then
    ...
    echo "[4/8] Node.js $NODE_VER (跳过)"
fi

# 5. 安装 openclaw
echo "[5/8] 安装/验证 openclaw..."
